	...
	var serverURL = "http://140.121.196.23:3390/BBDPPatient/ProfilePictureServlet?option=uploadProfilePicture";
	...
	$(document).ready(function() {
		...
		$("#profilePicture").append("<img style='height:30vw; width:30vw; margin-top: 6vw; object-fit:cover;' src='http://140.121.196.23:3390/BBDPPatient/ProfilePictureServlet?option=getProfilePicture&patientID="+patientID+"' onerror='failToLoadProfilePicture();'/>");
